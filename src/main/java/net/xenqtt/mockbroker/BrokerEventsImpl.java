...
final class BrokerEventsImpl implements BrokerEvents {
	...
	/**
	 * @see net.xenqtt.mockbroker.BrokerEvents#getEvents()
	 */
	@Override
	...
	/**
	 * @see net.xenqtt.mockbroker.BrokerEvents#getEvents(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see net.xenqtt.mockbroker.BrokerEvents#clearEvents()
	 */
	@Override
	...
	/**
	 * @see net.xenqtt.mockbroker.BrokerEvents#removeEvents(java.util.Collection)
	 */
	@Override
	...
	/**
	 * @see net.xenqtt.mockbroker.BrokerEvents#addEvent(net.xenqtt.mockbroker.BrokerEventType, net.xenqtt.mockbroker.Client)
	 */
	@Override
	...
	/**
	 * @see net.xenqtt.mockbroker.BrokerEvents#addEvent(net.xenqtt.mockbroker.BrokerEventType, net.xenqtt.mockbroker.Client,
	 *      net.xenqtt.message.MqttMessage)
	 */
	@Override
